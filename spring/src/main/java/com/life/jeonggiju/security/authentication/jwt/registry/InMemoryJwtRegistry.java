package com.life.jeonggiju.security.authentication.jwt.registry;
...
public class InMemoryJwtRegistry implements JwtRegistry {
	...
	public void registerJwtInformation(JwtInformation jwtInformation) {
		session.compute(jwtInformation.getPrincipal().getUserId(), (key, queue) -> {
			if (queue == null) {
	...
	public void rotateJwtInformation(String refreshToken, JwtInformation newJwtInformation) {
		session.computeIfPresent(newJwtInformation.getPrincipal().getUserId(), (key, queue) -> {
